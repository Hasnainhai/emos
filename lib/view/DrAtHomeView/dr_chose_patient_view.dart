...
class DrChosePatientView extends StatefulWidget {
  const DrChosePatientView({super.key});

  @override
  State<DrChosePatientView> createState() => _DrChosePatientViewState();
}

class _DrChosePatientViewState extends State<DrChosePatientView> {
  bool first = true;
  bool second = false;
